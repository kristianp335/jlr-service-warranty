...
/**
 * Provides the remote service interface for Warranty. Methods of this
...
@OSGiBeanProperties(property =  {
	"json.web.service.context.name=jlr", "json.web.service.context.path=Warranty"}, service = WarrantyService.class)
@ProviderType
@Transactional(isolation = Isolation.PORTAL, rollbackFor =  {
	PortalException.class, SystemException.class})
public interface WarrantyService extends BaseService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link WarrantyServiceUtil} to access the warranty remote service. Add custom service methods to {@link com.liferay.kris.jlr.warranty.service.impl.WarrantyServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	public java.lang.String addWarranty(ServiceContext serviceContext,
