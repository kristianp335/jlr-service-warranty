...
/**
 * Provides the local service interface for Warranty. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see WarrantyLocalServiceUtil
...
public interface WarrantyLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link WarrantyLocalServiceUtil} to access the warranty local service. Add custom service methods to {@link com.liferay.kris.jlr.warranty.service.impl.WarrantyLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	public Warranty createWarranty(long jlrWarrantyId);
	...
	*/
	...
	public Warranty deleteWarranty(Warranty warranty);
	...
	*/
	@Indexable(type = IndexableType.DELETE)
	public Warranty deleteWarranty(long jlrWarrantyId)
		throws PortalException;

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Warranty fetchWarranty(long jlrWarrantyId);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Warranty fetchWarrantyByUuidAndGroupId(java.lang.String uuid,
		long groupId);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Warranty getWarranty(long jlrWarrantyId) throws PortalException;
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Warranty getWarrantyByUuidAndGroupId(java.lang.String uuid,
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<Warranty> getWarranties(int start, int end);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<Warranty> getWarrantiesByUuidAndCompanyId(
